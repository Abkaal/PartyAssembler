...
<div class="wrapper">
	<div class="top">
		...
		<div class="menu">
			<div class="active"><a href="index.php" title="Main Page">Main Page</a></div>
	...
	<div class="gallery center">
		<h2>Welcome to the Party Assembler</h2>
		<br/><br/>
		<a href="register.php" title="Register">Register</a><br/>
		<a href="add_event.php" title="Create Event">Create Event</a><br/>
		<a href="events.php" title="List Events">List Events</a><br/>
	</div>
